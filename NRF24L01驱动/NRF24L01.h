...
void NRF24L01_R_RxFIFO_LatestData(NRF24L01_Driver_t *drv, NRF24L01_Pack_t *Rece);                               // 获取最新Rx_FIFO的值【静态载荷】【动态载荷】
...
bool NRF24L01_Check_FIFO_Status(NRF24L01_Driver_t *drv, Reg_FIFO_STATUS FIFO_MASK);                             // 检查FIFO状态
/*---------- 配 置 函 数 ----------*/
